...
import static com.rabhareit.tailing.configration.HttpClientConfigConstants.*;
...
public class ApacheHttpClientConfig {
   ...
   * @return
   *
   * refer to "https://github.com/spring-framework-guru/sfg-blog-posts/blob/master/resttemplate/src/main/java/guru/springframework/resttemplate/config/ApacheHttpClientConfig.java"
   *
   */
