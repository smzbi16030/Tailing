...
INSERT INTO temporary_account (id, admin, enabled, passwd, username) SELECT 9999, true, true, '$2a$10$mFcAEa95Awp93UeuBycVJe3dPhaHUX44a2mdrWdv4EZmtdd0K1UnO', 'yusuk' FROM dual WHERE NOT EXISTS (SELECT id FROM temporary_account WHERE username = 'yusuk')